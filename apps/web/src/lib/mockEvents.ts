...
// Showtimes specifically get a realistic evening curtain time (7:30 PM)
// rather than whatever time of day the site happened to build at.
...
export function seedEvents(): EventRecord[] {
  const ithaka: EventRecord = {
    ...
    // production — trailerUrl and castAndCrew are intentionally omitted
    // rather than filled with a stand-in video or invented names/photos of
    // people who don't actually work on this show. Add real values here
    // once PBAG supplies them; both <TrailerModal> and <CastAndCrew> already
